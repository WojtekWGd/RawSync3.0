...
namespace MVVMDemo.CustomMessageBox
{
    ...
    /// </summary>
    public static class WWMessageBox
    {
        /// <summary>
        ...
        /// <returns>A System.Windows.MessageBoxResult value that specifies which message box button is clicked by the user.</returns>
        public static MessageBoxResult Show(string messageBoxText, string caption, CustomMessageBoxButton button, MessageBoxImage icon)
        {
        ...
        /// <param name="icon">A System.Windows.MessageBoxImage value that specifies the icon to display.</param>
        /// <returns>A System.Windows.MessageBoxResult value that specifies which message box button is clicked by the user.</returns>
        public static MessageBoxResult ShowOKYesNoCancel(string messageBoxText, string caption, string okButtonText, string yesButtonText, string noButtonText, string cancelButtonText, MessageBoxImage icon)
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, CustomMessageBoxButton.OKYesNoCancel, icon);
            msg.OkButtonText = okButtonText;
            msg.YesButtonText = yesButtonText;
            msg.NoButtonText = noButtonText;
            msg.CancelButtonText = cancelButtonText;
